...
\begin{tabular}{l | l}
    ...
    Tools             & Git, Jira, npm, Maven, MongoDB, Contentful\\
    Frameworks        & Numpy, Flask, SciPy, express, Vue.js, OpenCV, Keras\\
    Software          & Visual Studio Code, JetBrains Suite, Microsoft Office, Docker\\
    Concepts & Computer Vision, Machine Learning\\
\end{tabular}
\vspace{-3mm}	
